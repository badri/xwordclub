...
urlpatterns = patterns('',
    ...
    url(r'^help/$', app.help, name='help'),
    url(r'^annotation/$', app.annotation, name='annotation'),
    url(r'^faq/$', app.faq, name='faq'),
    url(r'^legal/$', app.privacy, name='privacy'),
    ...
    url(r'^crosswords/$', app.questions, name='questions'),
    ...
    url(r'^clues/(?P<id>\d+)/comments/$', app.clue_comments, name='clue_comments'),
    url(r'^clues/(?P<id>\d+)/ratings/$', app.clue_ratings, name='clue_ratings'),
    url(r'^clues/(?P<clue_id>\d+)/comments/(?P<comment_id>\d+)/delete/$', app.delete_clue_comment, name='delete_clue_comment'),
    url(r'^peep/(?P<clue_id>\d+)/(?P<user_id>\d+)/$', app.peep_answers, name='peep_answers'),
    ...
    url(r'^crosswords/(?P<id>\d+)//*', app.question, name='question'),
    (r'^tags/$', app.tags),
